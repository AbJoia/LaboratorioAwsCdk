...
export class TodoTaskAppStack extends cdk.Stack{
    ...
    constructor(scope: Construct, id: string, props: TodoTaskAppStackProps){
        ...
        const todoTaskDtoLayerVersionArn = ssm.StringParameter.valueForStringParameter(this, "TodoTaskDtoLayerVersionArn")
        const todoTaskDtoLayer = lambda.LayerVersion.fromLayerVersionArn(this, "TodoTaskDtoLayerVersionArn", todoTaskDtoLayerVersionArn)
        ...
        batchTaskFunction.addEventSource(new lambdaEventSource.S3EventSource(s3Bucket, {
