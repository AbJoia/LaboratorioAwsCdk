...
export class TodoListApiStack extends cdk.Stack {
    ...
    private createCognitoAuth(){
        ...
        const userBasicResourceServer = this.userBasicPool.addResourceServer("UserBasicResourceServer", {
        ...
        this.adminTaskAuthorizer = new apiGateway.CognitoUserPoolsAuthorizer(this, "AdminTaskAuthorizer", {
